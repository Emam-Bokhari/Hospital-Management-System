...
const createAppointmentBookingController = asyncHandler(async (req, res) => {
  ...
  const createdAppointmentBooking =
    await AppointmentBookingServices.createAppointmentBooking(
...
const getAllAppointmentBookingsController = asyncHandler(async (req, res) => {
  const appointmentBookings =
    await AppointmentBookingServices.getAllAppointmentBookings();
...
const getAppointmentBookingController = asyncHandler(async (req, res) => {
  ...
  const appointmentBooking =
    await AppointmentBookingServices.getAppointmentBookingById(id);
...
const updateAppointmentBookingStatusController = asyncHandler(
  async (req, res) => {
    const id = req.params.id;
    const { status } = req.body;

    const updatedAppointmentBookingStatus =
      await AppointmentBookingServices.updateAppointmentBookingStatusById(
        id,
        status,
      );
