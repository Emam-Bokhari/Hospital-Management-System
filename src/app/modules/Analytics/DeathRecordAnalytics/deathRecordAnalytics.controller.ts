...
const getDeathRecordsOverviewController = asyncHandler(async (req, res) => {
  const overviewData =
    await DeathRecordAnalyticsServices.getDeathRecordsOverview();
...
const getDeathRecordsMonthlyStatsController = asyncHandler(async (req, res) => {
  ...
  const monthlyStatsData =
    await DeathRecordAnalyticsServices.getDeathRecordsMonthlyStats(
      year as string,
    );
  sendResponse(res, {
    success: true,
...
const getDeathRecordsCausesController = asyncHandler(async (req, res) => {
  ...
  const causesData = await DeathRecordAnalyticsServices.getDeathRecordsCauses(
    year as string,
    gender as string,
  );
  sendResponse(res, {
...
const getDeathRecordsGenderStatsController = asyncHandler(async (req, res) => {
  ...
  const genderStatsData =
    await DeathRecordAnalyticsServices.getDeathRecordsGenderStats(
      year as string,
    );
  sendResponse(res, {
    success: true,
...
const getDeathRecordsAgeGroupStatsController = asyncHandler(
  async (req, res) => {
    const year = req.query.year;
    const ageGroupStatsData =
      await DeathRecordAnalyticsServices.getDeathRecordsAgeGroupStats(
        year as string,
      );
    sendResponse(res, {
      success: true,
