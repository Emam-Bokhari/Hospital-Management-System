...
const getDeathRecordsAgeGroupStatsController = asyncHandler(async (req, res) => {
    const year = req.query.year;
    const ageGroupStatsData = await DeathRecordAnalyticsServices.getDeathRecordsAgeGroupStats(year as string);
    sendResponse(res, {
        success: true,
