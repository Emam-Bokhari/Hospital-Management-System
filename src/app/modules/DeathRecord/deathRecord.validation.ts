...
const createGuardianValidationSchema = z.object({
  ...
  nidNumber: z
    ...
    .optional(),
  nidScannedCopy: z.string().optional(),
});
...
const createDeathRecordValidationSchema = z.object({
  body: z.object({
    ...
    placeOfDeath: z
      ...
      .min(
        2,
        'Place of death is required and must contain at least 2 characters',
      )
    ...
    causeOfDeath: z
      ...
      .min(
        2,
        'Cause of death is required and must contain at least 2 characters',
      )
      .max(200, 'Cause of death cannot exceed 200 characters'),
    deathCertificateNo: z.string().optional(),
