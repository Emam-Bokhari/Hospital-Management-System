...
router.post("/", validateRequestSchema(StaffRoleValidationSchema), StaffRoleControllers.createStaffRoleController);

router.get("/", StaffRoleControllers.getAllStaffRolesController);

router.get("/:id", StaffRoleControllers.getStaffRoleController);

router.patch("/:id", validateRequestSchema(StaffRoleValidationSchema), StaffRoleControllers.updateStaffRoleController);
