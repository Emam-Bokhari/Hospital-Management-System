...
import { TAddress, TAdmissionBooking, TContactInformation, TGuardian } from "./admissionBooking.interface";
...
export const AdmissionBooking = model<TAdmissionBooking>("AdmissionBooking", admissionBookingSchema)