...
router.post("/", validateRequestSchema(AdmissionBookingValidationSchema.createAdmissionBookingValidationSchema), AdmissionBookingControllers.createAdmissionBookingController);
