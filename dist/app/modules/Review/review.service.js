...
const createReview = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if ((0, textFilter_1.filterBadWords)(payload.reviewText)) {
        throw new HttpError_1.HttpError(400, "Your review contains inappropriate language. Please remove it.");
    }
...
const getAllReviews = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (reviews.length === 0) {
        throw new HttpError_1.HttpError(404, 'No review were found in the database');
    }
    return reviews;
});
const getReviewsByDoctorId = (doctorId) => __awaiter(void 0, void 0, void 0, function* () {
    const reviews = yield review_model_1.Review.find({ doctorId: doctorId });
    if (reviews.length === 0) {
        throw new HttpError_1.HttpError(404, `No review were found with ID ${doctorId}`);
    }
    return reviews;
});
...
const deleteReviewById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deletedReview = yield review_model_1.Review.findOneAndUpdate({ _id: id, isDeleted: false }, { isDeleted: true }, { new: true });
    if (!deletedReview) {
        throw new HttpError_1.HttpError(404, `No review found with ID: ${id}`);
    }
