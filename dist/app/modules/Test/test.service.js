...
const getAllTests = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const tests = yield test_model_1.Test.find().populate({
      path: 'createdBy',
    ...
    if (tests.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        'No tests were found in the database',
      );
    }
    return tests;
  });
const getTestById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const test = yield test_model_1.Test.findById(id).populate({
      path: 'createdBy',
      select: 'firstName lastName email',
    });
    if (!test) {
...
const updateTestById = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedTest = yield test_model_1.Test.findOneAndUpdate(
...
const deleteTestById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const deletedTest = yield test_model_1.Test.findOneAndUpdate(
      { _id: id, isDeleted: false },
      { isDeleted: true },
      { new: true },
    );
...
const updateTestAvailabilityById = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (payload.testAvailability === undefined) {
      throw new HttpError_1.HttpError(
        400,
        'Test availability status is required',
      );
    }
    const updatedTestAvailability = yield test_model_1.Test.findOneAndUpdate(
      { _id: id, isDeleted: false },
      payload,
      { new: true, runValidators: true },
    );
