...
router.post(
  ...
  (0, validateRequestSchema_1.validateRequestSchema)(
    test_validation_1.TestValidationSchema.createTestValidationSchema,
  ),
  test_controller_1.TestControllers.createTestController,
);
...
router.patch(
  '/:id',
  (0, validateRequestSchema_1.validateRequestSchema)(
    test_validation_1.TestValidationSchema.updateTestValidationSchema,
  ),
  test_controller_1.TestControllers.updateTestController,
);
router.patch(
  '/:id/availability',
  (0, validateRequestSchema_1.validateRequestSchema)(
    test_validation_1.TestValidationSchema
      .testAvailabilityUpdateValidationSchema,
  ),
  test_controller_1.TestControllers.updateTestAvailabilityController,
);
