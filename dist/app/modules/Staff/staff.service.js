...
const createStaff = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const staffRole = yield staffRole_model_1.StaffRole.findOne({
      _id: payload.staffRole,
    })
      .select('_id')
      .lean();
    if (!staffRole) {
      throw new HttpError_1.HttpError(
        404,
        'No Staff role found the provided ID',
      );
    }
...
const getAllStaffs = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (staffs.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        'No staffs were found in the database',
      );
    }
    return staffs;
  });
...
const updateStaffById = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
        contactInformation,
        emergencyContact,
      ...
      remainingStaffData = __rest(payload, [
        'contactInformation',
        'emergencyContact',
        'birthCertificate',
        'workSchedule',
    ...
    const updatedStaff = yield staff_model_1.Staff.findOneAndUpdate(
...
const deleteStaffById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const deletedStaff = yield staff_model_1.Staff.findOneAndUpdate(
      { _id: id, isDeleted: false },
      { isDeleted: true },
      { new: true },
    );
