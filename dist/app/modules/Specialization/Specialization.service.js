...
const createSpecialization = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // check if specialization name is already exists
    const existingSpecialization =
      yield specialization_model_1.Specialization.findOne({
    ...
    const createdSpecialization =
      yield specialization_model_1.Specialization.create(payload);
    return createdSpecialization;
  });
const getAllSpecializations = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const specializations =
      yield specialization_model_1.Specialization.find().populate({
        path: 'createdBy',
    ...
    if (specializations.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        'No specialization were found in the database',
      );
    }
...
const getSpecializationById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const specialization = yield specialization_model_1.Specialization.findById(
      id,
    ).populate({
      path: 'createdBy',
      select: 'firstName lastName email',
    ...
    if (!specialization) {
      throw new HttpError_1.HttpError(
        404,
        `No specialization found with ID: ${id}`,
      );
    }
    return specialization;
  });
const updateSpecializationById = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const existingSpecialization =
      yield specialization_model_1.Specialization.findOne({
        _id: id,
    ...
    const updatedSpecialization =
      yield specialization_model_1.Specialization.findOneAndUpdate(
