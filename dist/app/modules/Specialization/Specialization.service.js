...
const getAllSpecializations = () => __awaiter(void 0, void 0, void 0, function* () {
    const specializations = yield specialization_model_1.Specialization.find().populate({
        path: 'createdBy',
...
const getSpecializationById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const specialization = yield specialization_model_1.Specialization.findById(id).populate({
        path: 'createdBy',
        select: 'firstName lastName email',
    });
    if (!specialization) {
