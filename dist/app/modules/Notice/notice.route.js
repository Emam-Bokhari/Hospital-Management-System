...
router.get('/:role', notice_controller_1.NoticeControllers.getNoticesByRoleController);
router.get('/:id', notice_controller_1.NoticeControllers.getNoticeByIdController);
router.delete('/:id', notice_controller_1.NoticeControllers.deleteNoticeByIdController);
