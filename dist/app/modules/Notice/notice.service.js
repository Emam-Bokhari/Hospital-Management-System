...
exports.NoticeServices = exports.getNoticeById = exports.getNoticesByRole = exports.getAllNotices = void 0;
...
const getAllNotices = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (notices.length === 0) {
        throw new HttpError_1.HttpError(404, 'No notice were found in the database');
    }
    return notices;
});
exports.getAllNotices = getAllNotices;
const getNoticesByRole = (role) => __awaiter(void 0, void 0, void 0, function* () {
    const notices = yield notice_model_1.Notice.find({ targetAudience: role });
    if (notices.length === 0) {
        throw new HttpError_1.HttpError(404, `No notice were found with role ${role}`);
    }
    return notices;
});
...
const deleteNoticeById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deletedNotice = yield notice_model_1.Notice.findOneAndUpdate({ _id: id, isDeleted: false }, { isDeleted: true }, { new: true });
    if (!deletedNotice) {
        throw new HttpError_1.HttpError(404, `No notice found with ID: ${id}`);
    }
