...
exports.NoticeControllers =
  exports.getNoticesByRoleController =
...
const createNoticeController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const noticePayload = req.body;
    const createdNotice =
      yield notice_service_1.NoticeServices.createNotice(noticePayload);
...
exports.getAllNotices = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.getNoticesByRoleController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const role = req.params.role;
      const notices =
        yield notice_service_1.NoticeServices.getNoticesByRole(role);
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
        message: 'Notice are retrieved successfully',
        statusCode: 200,
...
const getNoticeByIdController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteNoticeByIdController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const id = req.params.id;
