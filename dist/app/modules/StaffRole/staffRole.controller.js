...
const createStaffRoleController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const staffRolePayload = req.body;
    const createdStaffRole =
      yield staffRole_service_1.StaffRoleServices.createStaffRole(
        staffRolePayload,
      );
...
const getAllStaffRolesController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const staffRoles =
        yield staffRole_service_1.StaffRoleServices.getAllStaffRoles();
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const getStaffRoleController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const staffRole =
      yield staffRole_service_1.StaffRoleServices.getStaffRoleById(id);
    (0, sendResponse_1.sendResponse)(res, {
      success: true,
...
const updateStaffRoleController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updatedPayload = req.body;
    const updatedStaffRole =
      yield staffRole_service_1.StaffRoleServices.updateStaffRoleById(
        id,
        updatedPayload,
      );
    (0, sendResponse_1.sendResponse)(res, {
...
const deleteStaffRoleController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
