...
router.post('/', (0, validateRequestSchema_1.validateRequestSchema)(staffRole_validation_1.StaffRoleValidationSchema), staffRole_controller_1.StaffRoleControllers.createStaffRoleController);
...
router.patch('/:id', (0, validateRequestSchema_1.validateRequestSchema)(staffRole_validation_1.StaffRoleValidationSchema), staffRole_controller_1.StaffRoleControllers.updateStaffRoleController);
