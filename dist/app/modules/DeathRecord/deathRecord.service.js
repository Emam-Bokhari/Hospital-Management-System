...
const createDeathRecord = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const deathCertificateNo = yield (0, deathRecord_utils_1.generateDeathCertificateNo)();
    payload.deathCertificateNo = deathCertificateNo;
    const createdDeathRecord = yield deathRecord_model_1.DeathRecord.create(payload);
    return createdDeathRecord;
});
const getAllDeathRecords = () => __awaiter(void 0, void 0, void 0, function* () {
    const deathRecords = yield deathRecord_model_1.DeathRecord.find().populate({
        path: 'createdBy',
        select: 'firstName lastName email role',
    });
    if (deathRecords.length === 0) {
        throw new HttpError_1.HttpError(404, 'No death record were found in the database');
    }
    return deathRecords;
});
const getDeathRecordById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deathRecord = yield deathRecord_model_1.DeathRecord.findById(id).populate({
        path: 'createdBy',
        select: 'firstName lastName email role',
    });
    if (!deathRecord) {
        throw new HttpError_1.HttpError(404, `No death record found with ID: ${id}`);
    }
    return deathRecord;
});
const updateDeathRecordById = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedDeathRecord = yield deathRecord_model_1.DeathRecord.findOneAndUpdate({ _id: id, isDeleted: false }, modifiedUpdatedData, { new: true, runValidators: true });
    if (!updatedDeathRecord) {
        throw new HttpError_1.HttpError(404, `No death record found with ID: ${id}`);
    }
    return updatedDeathRecord;
});
const deleteDeathRecordById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deletedDeathRecord = yield deathRecord_model_1.DeathRecord.findOneAndUpdate({ _id: id, isDeleted: false }, { isDeleted: true }, { new: true });
