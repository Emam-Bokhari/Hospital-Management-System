...
router.post('/', deathRecord_controller_1.DeathRecordControllers.createDeathRecordController);
...
router.patch('/:id', deathRecord_controller_1.DeathRecordControllers.updateDeathRecordController);
