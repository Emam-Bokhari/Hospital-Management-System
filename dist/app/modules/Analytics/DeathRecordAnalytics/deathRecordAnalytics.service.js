...
const getDeathRecordsOverview = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    ...
    const totalRecords = ((_a = data.totalRecords[0]) === null || _a === void 0 ? void 0 : _a.total) || 0;
    const totalMales = ((_b = data.totalMales[0]) === null || _b === void 0 ? void 0 : _b.total) || 0;
    const totalFemales = ((_c = data.totalFemales[0]) === null || _c === void 0 ? void 0 : _c.total) || 0;
    const currentYearRecords = ((_d = data.currentYearRecords[0]) === null || _d === void 0 ? void 0 : _d.total) || 0;
    const mostCommonCause = ((_e = data.mostCommonCause[0]) === null || _e === void 0 ? void 0 : _e._id) || 'N/A';
    return {
        totalRecords,
        totalMales,
        totalFemales,
...
const getDeathRecordsMonthlyStats = (year) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, deathRecordAnalytics_utils_1.formatMonthlyStats)(monthlyStatsData);
});
const getDeathRecordsCauses = (year, gender) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeathRecordsGenderStats = (year) => __awaiter(void 0, void 0, void 0, function* () {
    const currentYear = year ? Number(year) : new Date().getFullYear();
...
const getDeathRecordsAgeGroupStats = (year) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filledAgeGroups = deathRecordAnalytics_utils_1.defaultAgeGroups.map((group) => {
        const matchedGroup = ageGroupStatsData.find((data) => {
            const groupName = (0, deathRecordAnalytics_utils_1.getAgeGroup)(data._id);
