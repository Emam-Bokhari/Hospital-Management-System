...
const getDeathRecordsOverviewController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const overviewData =
        yield deathRecordAnalytics_service_1.DeathRecordAnalyticsServices.getDeathRecordsOverview();
...
const getDeathRecordsMonthlyStatsController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const year = req.query.year;
      const monthlyStatsData =
        yield deathRecordAnalytics_service_1.DeathRecordAnalyticsServices.getDeathRecordsMonthlyStats(
          year,
        );
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const getDeathRecordsCausesController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const year = req.query.year;
      const gender = req.query.gender;
      const causesData =
        yield deathRecordAnalytics_service_1.DeathRecordAnalyticsServices.getDeathRecordsCauses(
          year,
          gender,
        );
      (0, sendResponse_1.sendResponse)(res, {
...
const getDeathRecordsGenderStatsController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const year = req.query.year;
      const genderStatsData =
        yield deathRecordAnalytics_service_1.DeathRecordAnalyticsServices.getDeathRecordsGenderStats(
          year,
        );
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const getDeathRecordsAgeGroupStatsController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const year = req.query.year;
      const ageGroupStatsData =
        yield deathRecordAnalytics_service_1.DeathRecordAnalyticsServices.getDeathRecordsAgeGroupStats(
          year,
        );
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
