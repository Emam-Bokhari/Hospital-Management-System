...
const updateDepartmentController = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updatedPayload = req.body;
    const updatedDepartment = yield department_service_1.DepartmentServices.updateDepartmentById(id, updatedPayload);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
