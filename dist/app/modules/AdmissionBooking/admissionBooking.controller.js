...
const createAdmissionBookingController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const admissionBookingPayload = req.body;
      const createdAdmissionBooking =
        yield admissionBooking_service_1.AdmissionBookingServices.createAdmissionBooking(
...
const getAllAdmissionBookingsController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const admissionBookings =
        yield admissionBooking_service_1.AdmissionBookingServices.getAllAdmissionBookings();
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const getAdmissionBookingByIdController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const id = req.params.id;
      const admissionBooking =
        yield admissionBooking_service_1.AdmissionBookingServices.getAdmissionBookingById(
          id,
        );
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const updateAdmissionBookingStatusByIdController = (0,
asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const { status } = req.body;
    const updatedAdmissionBookingStatus =
      yield admissionBooking_service_1.AdmissionBookingServices.updateAdmissionBookingStatusById(
        id,
        status,
      );
    (0, sendResponse_1.sendResponse)(res, {
