...
const createTestBooking = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const testBookingId = yield (0,
    testBooking_utils_1.generateTestBookingId)();
    payload.id = testBookingId;
    // TODO: payment related validation
    const createdTestBooking =
      yield testBooking_model_1.TestBooking.create(payload);
    return createdTestBooking;
  });
const getAllTestBookings = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (testBookings.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        'No test bookings were found in the database',
      );
    }
    return testBookings;
  });
const getTestBookingById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!testBooking) {
      throw new HttpError_1.HttpError(
        404,
        `No test booking found with ID: ${id}`,
      );
    }
    return testBooking;
  });
const updateTestBookingStatusById = (id, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedTestBookingStatus =
      yield testBooking_model_1.TestBooking.findOneAndUpdate(
        { _id: id },
        { status },
    ...
    if (!updatedTestBookingStatus) {
      throw new HttpError_1.HttpError(
        404,
        `Test booking with ID: ${id} not found`,
      );
    }
