...
const createAppointmentBookingController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const appointmentBookingPayload = req.body;
      const createdAppointmentBooking =
        yield appointmentBooking_service_1.AppointmentBookingServices.createAppointmentBooking(
...
const getAllAppointmentBookingsController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const appointmentBookings =
        yield appointmentBooking_service_1.AppointmentBookingServices.getAllAppointmentBookings();
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const getAppointmentBookingController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const id = req.params.id;
      const appointmentBooking =
        yield appointmentBooking_service_1.AppointmentBookingServices.getAppointmentBookingById(
          id,
        );
      (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const updateAppointmentBookingStatusController = (0,
asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const { status } = req.body;
    const updatedAppointmentBookingStatus =
      yield appointmentBooking_service_1.AppointmentBookingServices.updateAppointmentBookingStatusById(
        id,
        status,
      );
    (0, sendResponse_1.sendResponse)(res, {
