...
const createBedController = (0, asyncHandler_1.asyncHandler)((req, res) =>
...
const getAllBedsController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getBedController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateBedController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updatedPayload = req.body;
    const updatedBed = yield bed_service_1.BedServices.updateBedById(
      id,
      updatedPayload,
    );
    (0, sendResponse_1.sendResponse)(res, {
...
const updateBedAvailabilityStatusController = (0, asyncHandler_1.asyncHandler)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const id = req.params.id;
      const { availabilityStatus } = req.body;
      const updatedBedAvailabilityStatus =
        yield bed_service_1.BedServices.updateBedAvailabilityStatusById(
          id,
          availabilityStatus,
        );
      (0, sendResponse_1.sendResponse)(res, {
...
const deleteBedController = (0, asyncHandler_1.asyncHandler)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
