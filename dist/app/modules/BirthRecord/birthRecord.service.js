...
const createBirthRecord = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const createdBirthRecord =
      yield birthRecord_model_1.BirthRecord.create(payload);
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (birthRecords.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        "No birth record were found in the database'",
      );
    }
    return birthRecords;
  });
const getBirthRecordById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const birthRecord = yield birthRecord_model_1.BirthRecord.findById(
      id,
    ).populate({
      path: 'createdBy',
      select: 'firstName lastName email role',
...
const updateBirthRecordById = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedBirthRecord =
      yield birthRecord_model_1.BirthRecord.findOneAndUpdate(
    ...
    if (!updatedBirthRecord) {
      throw new HttpError_1.HttpError(
        404,
        `No birth record found with ID: ${id}`,
      );
    }
    return updatedBirthRecord;
  });
const deleteBirthRecordById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const deletedBirthRecord =
      yield birthRecord_model_1.BirthRecord.findOneAndUpdate(
        { _id: id, isDeleted: false },
        { isDeleted: true },
        { new: true },
