...
const updateBirthRecordById = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedBirthRecord = yield birthRecord_model_1.BirthRecord.findOneAndUpdate({ _id: id, isDeleted: false }, { $set: modifiedUpdatedData }, { new: true, runValidators: true });
