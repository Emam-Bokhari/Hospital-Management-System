...
const createExpenses = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.expenseType === 'staffSalaries') {
      ...
      const monthlySalary =
        ((_a = staff.payrollInformation) === null || _a === void 0
          ? void 0
          : _a.monthlySalary) || 0;
    ...
    if (payload.expenseType === 'medicalSupplies') {
      if (!payload.medicalSupplies) {
        throw new HttpError_1.HttpError(
          400,
          'Medical supplies information is required.',
        );
      }
    ...
    if (payload.expenseType === 'diagnosticTools') {
      if (!payload.diagnosticTools) {
        throw new HttpError_1.HttpError(
          400,
          'Diagnostic tools information is required.',
        );
      }
    ...
    if (payload.expenseType === 'government') {
      if (!payload.government) {
        throw new HttpError_1.HttpError(
          400,
          'Government information is required.',
        );
      }
    }
    // handle others
...
const getAllExpenses = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (expenses.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        'No expenses were found in the database',
      );
    }
    return expenses;
  });
const getExpensesByType = (type) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (expenses.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        `No expenses were found with type ${type}`,
      );
    }
    return expenses;
  });
...
const deleteExpensesById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const deletedExpenses = yield expenses_model_1.Expenses.findOneAndUpdate(
