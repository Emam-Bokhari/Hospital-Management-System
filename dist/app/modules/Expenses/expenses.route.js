...
router.post("/", expenses_controller_1.ExpensesControllers.createExpensesController);
router.get("/", expenses_controller_1.ExpensesControllers.getAllExpenses);
router.get("/type/:type", expenses_controller_1.ExpensesControllers.getExpensesByType);
router.get("/:id", expenses_controller_1.ExpensesControllers.getExpensesById);
router.delete("/:id", expenses_controller_1.ExpensesControllers.deleteExpensesById);
