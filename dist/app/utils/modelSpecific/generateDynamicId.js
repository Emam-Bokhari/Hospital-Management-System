...
const generateDynamicId = (model_1, prefix_1, ...args_1) =>
  __awaiter(
    void 0,
    [model_1, prefix_1, ...args_1],
    void 0,
    function* (model, prefix, fieldName = 'id') {
      var _a, _b;
      try {
        ...
        const lastDatePart =
          (_a =
            lastRecord === null || lastRecord === void 0
              ? void 0
              : lastRecord[fieldName]) === null || _a === void 0
            ? void 0
            : _a.slice(4, 12);
        const lastUniquePart =
          (_b =
            lastRecord === null || lastRecord === void 0
              ? void 0
              : lastRecord[fieldName]) === null || _b === void 0
            ? void 0
            : _b.slice(13);
